      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 md:grid-cols-2 md:gap-16 md:px-8">
        ...
        <Reveal delay={120}>
          ...
          <p className="mt-6 text-pretty leading-relaxed text-muted-foreground">
            A-Z הוא שירות מלא המכסה כל היבט במסע הנדל"ן היוקרתי בירושלים: מתמיכה משפטית ועיצוב, דרך פיננסים, קשר ישיר עם
            ספקים ויבואנים ועד ניהול נכסים. אנחנו מוודאים שכל שלב יהיה חלק, בטוח, ומטופל על ידי אנשי המקצוע הטובים
            והמומלצים ביותר.
          </p>
