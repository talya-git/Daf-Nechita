      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 md:grid-cols-2 md:gap-16 md:px-8">
        ...
        <Reveal className="order-1 md:order-2" delay={120}>
          ...
          <p className="mt-6 text-pretty leading-relaxed text-muted-foreground">
            ...
            בטוחים ונינוחים. מהשלבים הראשונים של תכנון פיננסי, דרך שיקולים משפטיים ועד לעיצוב החזון שלכם לבית.
          </p>
          <p className="mt-4 text-pretty leading-relaxed text-muted-foreground">
            לאחר שליווינו אלפי רוכשים מהקהילות היהודיות ברחבי העולם ומהארץ בשלושת העשורים האחרונים, צברנו ניסיון שמאפשר
            לנו להפוך את תהליך הרכישה למקצועי ומהנה, ולהביא אתכם לחנוכת הבית החדש עם חיוך גדול.
          </p>
